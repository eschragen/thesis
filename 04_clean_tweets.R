...
clean_corpus = function(corpus){
  ...
  corpus = tm_map(corpus, removeWords,c(stopwords("en"),"vw", "volkswagen", "shell", "starbucks", 
                                       "nestle", "mcdonalds","mcdonald", "mc donald's", "ikea", "hm", "exxonmobil", "exxon mobil", 
...
content = as.data.frame(t(sapply(tweets_corpus_clean, function(x){x$content})))     #transponse (t) when you apply lemmatization
