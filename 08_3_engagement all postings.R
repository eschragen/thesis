...
for (i in 1:length(claims_vec)) {
  tweets = get_all_tweets(
    ...
    data_path = paste("C:/Users/eva_s/OneDrive/Desktop/conversations_all_claims/company_conversation",i,"/",sep=""),
    n = Inf
  )
}
...
for (i in 2:147) {
  total_df_cocacola = rbind(total_df_cocacola, 
                            (cbind(bind_tweets(data_path = paste("C:/Users/eva_s/OneDrive/MASTER/5. Semester_THESIS/Data Analytics/DATA/conversations_all_claims/company_conversation",i,"/",sep=""))$created_at ,bind_tweets(data_path = paste("C:/Users/eva_s/OneDrive/MASTER/5. Semester_THESIS/Data Analytics/DATA/conversations_all_claims/company_conversation",i,"/",sep=""))$conversation_id)))
}
total_df_cocacola = cbind(total_df_cocacola, "cocacola")

total_df_exxonmobil = cbind(bind_tweets(data_path = "C:/Users/eva_s/OneDrive/MASTER/5. Semester_THESIS/Data Analytics/DATA/conversations_all_claims/company_conversation148")$created_at, bind_tweets(data_path = "C:/Users/eva_s/OneDrive/MASTER/5. Semester_THESIS/Data Analytics/DATA/conversations_all_claims/company_conversation148")$conversation_id)   
...
total_df_hm = cbind(bind_tweets(data_path = "C:/Users/eva_s/OneDrive/MASTER/5. Semester_THESIS/Data Analytics/DATA/conversations_all_claims/company_conversation233")$created_at, bind_tweets(data_path = "C:/Users/eva_s/OneDrive/MASTER/5. Semester_THESIS/Data Analytics/DATA/conversations_all_claims/company_conversation233")$conversation_id)   
...
total_df_ikea = cbind(bind_tweets(data_path = "C:/Users/eva_s/OneDrive/MASTER/5. Semester_THESIS/Data Analytics/DATA/conversations_all_claims/company_conversation351")$created_at, bind_tweets(data_path = "C:/Users/eva_s/OneDrive/MASTER/5. Semester_THESIS/Data Analytics/DATA/conversations_all_claims/company_conversation351")$conversation_id)   
...
total_df_nestle = cbind(bind_tweets(data_path = "C:/Users/eva_s/OneDrive/MASTER/5. Semester_THESIS/Data Analytics/DATA/conversations_all_claims/company_conversation528")$created_at, bind_tweets(data_path = "C:/Users/eva_s/OneDrive/MASTER/5. Semester_THESIS/Data Analytics/DATA/conversations_all_claims/company_conversation528")$conversation_id)   
...
total_df_shell = cbind(bind_tweets(data_path = "C:/Users/eva_s/OneDrive/MASTER/5. Semester_THESIS/Data Analytics/DATA/conversations_all_claims/company_conversation1042")$created_at, bind_tweets(data_path = "C:/Users/eva_s/OneDrive/MASTER/5. Semester_THESIS/Data Analytics/DATA/conversations_all_claims/company_conversation1042")$conversation_id)   
...
total_df_unilever = cbind(bind_tweets(data_path = "C:/Users/eva_s/OneDrive/MASTER/5. Semester_THESIS/Data Analytics/DATA/conversations_all_claims/company_conversation1171")$created_at, bind_tweets(data_path = "C:/Users/eva_s/OneDrive/MASTER/5. Semester_THESIS/Data Analytics/DATA/conversations_all_claims/company_conversation1171")$conversation_id)   
